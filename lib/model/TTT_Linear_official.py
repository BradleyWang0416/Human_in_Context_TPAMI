    ...
    def ttt(
        ...
        def compute_mini_batch(params_dict, inputs):
            ...
            if use_dual_form:
                ...
                test_variable1 = XQ_mini_batch @ W1_init
                test_variable2 = eta_mini_batch * Attn1
                test_variable3 = test_variable2 @ grad_l_wrt_Z1
                Z1_bar = test_variable1 - test_variable3 + b1_bar
