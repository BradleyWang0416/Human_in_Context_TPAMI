...
class  Skeleton_in_Context(MixSTE2):
    def __init__(self, num_frame=9, num_joints=17, in_chans=2, embed_dim_ratio=32, depth=4, num_heads=8, mlp_ratio=2, 
        ...
        self.temp_conv_query = nn.ModuleList([
            nn.Conv2d(embed_dim_ratio, embed_dim_ratio, kernel_size=(2,1)),
            nn.Conv2d(embed_dim_ratio, embed_dim_ratio, kernel_size=(2,1)),
            nn.Conv2d(embed_dim_ratio, embed_dim_ratio, kernel_size=(4,1)),
            nn.Identity(),
            nn.ConvTranspose2d(embed_dim_ratio, embed_dim_ratio, kernel_size=(4,1)),
            nn.ConvTranspose2d(embed_dim_ratio, embed_dim_ratio, kernel_size=(2,1)),
            nn.ConvTranspose2d(embed_dim_ratio, embed_dim_ratio, kernel_size=(2,1))
        ])
