...
def main():
    ...
    amass_input_length = 10     # default: 10
    amass_target_length = 10    # default: 10
    test_shift = 100             # default: 20
    train_shift = 400            # default: 20
    ############################# customize #############################

    if use_default_setting:
        clip_len, amass_input_length, amass_target_length, test_shift, train_shift = 16, 10, 10, 20, 20
        save_root_path = f"data/AMASS"
    else:
        save_root_path = 'data/non_default/AMASS/'
        save_folder = f'TrainShift{train_shift}_TestShift{test_shift}_ClipLen{clip_len}_In{amass_input_length}_Out{amass_target_length}'
