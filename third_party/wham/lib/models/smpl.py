...
class SMPL(_SMPL):
    ...
    def get_output(self, *args, **kwargs):
        ...
        joints = vertices2joints(self.J_regressor_wham, smpl_output.vertices)       # joints: [82,31,3]  <<<---  self.J_regressor_wham: [31,6890]. smpl_output.vertices: [82,6890,3]
        if kwargs['get_h36m_skel']:
            joints_h36m = vertices2joints(self.J_regressor_eval, smpl_output.vertices)
        ...
        if kwargs['get_h36m_skel']:
            output.joints_h36m = joints_h36m
        return output
