...
raw_dir = 'data/source_data/AMASS'
...
with open('data_icl_gen/processed_data/AMASS/fps.csv', 'w') as f:
...
with open("data_icl_gen/processed_data/AMASS/all_motions_fps%d.pkl" % target_fps, "wb") as myprofile:  
